...
def bm25_search(bm25, chunks, question, limit=5):
...
def normalize_scores(results):
    ...
    for result in results:
        ...
        normalized[result["chunk_index"]] = normalized_score

    return normalized


def hybrid_search(question, chunks, bm25, limit=5):
    ...
    for chunk_index in set(vector_scores) | set(bm25_scores):
        ...
        combined_scores[chunk_index] = hybrid_score
